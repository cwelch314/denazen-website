export default {
  ...
  sections: [
    ...
    },
    {
      heading: 'Sharing',
      paragraphs: [
        'We do not sell your personal information. Limited information is shared with service providers strictly to operate Rhize (e.g., infrastructure hosting, email delivery for account communication). Public content is shared through the AT Protocol network by design.',
      ],
    },
    {
      heading: 'Your choices',
      list: [
        { body: 'You can request deletion of your Rhize account.' },
