export default {
  meta: {
    title: 'Rhize — A private, encrypted space for your real relationships',
    description:
  ...
  freedom: {
    ...
    intro:
      "Rhize runs on the AT Protocol, the open social network behind Bluesky and 40+ million people. Dive into any topic you care about and discover what's actually happening, not what an algorithm picked for you.",
    list: [
