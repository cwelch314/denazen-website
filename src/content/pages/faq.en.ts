export default {
  meta: {
    title: 'Rhize',
    description: 'Answers to common questions about Rhize: what it is, how privacy works, and how to get in.',
  },
  heading: 'Frequently asked questions',
  lead: 'The short version: Rhize is a privacy-first social network on Bluesky, with private circles only your chosen recipients can read.',
  groups: [
    {
      heading: 'Product',
      items: [
        {
          q: 'What is Rhize?',
          a: ["Rhize is a social network with two layers. The public layer is standard Bluesky — open posts, open follows, open discovery. The private layer is end-to-end encrypted content that only the people you've added to a circle can read."],
        },
        {
          q: 'How does Rhize relate to Bluesky?',
          a: ['Rhize is built on the AT Protocol, the same open protocol that powers Bluesky. Your public posts live on Bluesky. Your Bluesky handle works here. Your followers come with you. The private layer is an additional capability Rhize adds on top.'],
        },
        {
          q: "What's a Circle?",
      ...
      items: [
        {
          ...
          a: ["Private content is encrypted on your device before it's ever sent. The decryption keys only exist on the devices of people you've shared with. Rhize's servers and Bluesky's servers store the ciphertext but cannot read it."],
        },
        {
          q: 'Can Rhize read my private posts?',
        ...
        },
        {
          ...
          a: ["Private content is encrypted before it leaves your device. Whatever path it takes — Bluesky PDSes, Rhize's servers — it's ciphertext everywhere except on the devices of your chosen recipients."],
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          q: 'When can I join?',
          a: ["Rhize is in a small invite-only beta right now. Join the waitlist and we'll reach out as we open up more invites."],
        },
        {
      ...
      items: [
        {
          ...
          a: ["Yes — Rhize uses AT Protocol identity. If you don't have a Bluesky handle yet, creating one takes a minute and you can use it here."],
        },
        {
          q: 'What about my existing Bluesky handle and follows?',
          a: ["They come with you. Your public posts and follows on Bluesky remain exactly what they are today. Rhize adds the private layer; it doesn't replace the public one."],
        },
        {
        ...
        },
        {
          ...
          a: [
            'Your private content becomes permanently inaccessible. This is intentional: if Rhize had a way to recover it for you, Rhize would also be able to read your private content — breaking the core promise.',
        ...
        {
          q: 'Can I use Rhize on more than one device?',
          a: [
            "Yes. Rhize is multi-device by design. You don't pair devices or sync keys between them manually; your encrypted keys already live on public infrastructure (Rhize's server and your Bluesky PDS), and any device can unlock them with the same three credentials: your Bluesky handle, your Bluesky password, and your Rhize encryption password.",
