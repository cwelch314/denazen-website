export default {
  ...
  sections: [
    ...
    },
    {
      heading: 'Compartir',
      paragraphs: [
        'No vendemos tu información personal. Se comparte información limitada con proveedores de servicios estrictamente para operar Rhize (por ejemplo, alojamiento de infraestructura, envío de correos para comunicación de la cuenta). El contenido público se comparte a través de la red del AT Protocol por diseño.',
      ],
    },
    {
      heading: 'Tus opciones',
      list: [
        { body: 'Puedes solicitar la eliminación de tu cuenta de Rhize.' },
