export default {
  ...
  lead: 'La versión corta: Penrose es una red social con privacidad primero sobre Bluesky, con círculos privados que solo los destinatarios que elijas pueden leer.',
  groups: [
    {
      heading: 'Producto',
      items: [
        {
          q: '¿Qué es Penrose?',
          a: ['Penrose es una red social con dos capas. La capa pública es Bluesky estándar — publicaciones abiertas, seguimientos abiertos, descubrimiento abierto. La capa privada es contenido cifrado de extremo a extremo que solo pueden leer las personas que hayas añadido a un círculo.'],
        },
        {
          q: '¿Cómo se relaciona Penrose con Bluesky?',
          a: ['Penrose está construido sobre el AT Protocol, el mismo protocolo abierto que impulsa a Bluesky. Tus publicaciones públicas viven en Bluesky. Tu nombre de usuario de Bluesky funciona aquí. Tus seguidores vienen contigo. La capa privada es una capacidad adicional que Penrose añade encima.'],
        },
        {
          q: '¿Qué es un Círculo?',
      ...
      items: [
        {
          ...
          a: ['El contenido privado se cifra en tu dispositivo antes de enviarse. Las llaves de descifrado solo existen en los dispositivos de las personas con las que has compartido. Los servidores de Penrose y los servidores de Bluesky almacenan el texto cifrado pero no pueden leerlo.'],
        },
        {
          q: '¿Puede Penrose leer mis publicaciones privadas?',
        ...
        },
        {
          ...
          a: ['El contenido privado se cifra antes de salir de tu dispositivo. Sea cual sea el camino que tome — PDS de Bluesky, servidores de Penrose — es texto cifrado en todas partes excepto en los dispositivos de los destinatarios que elegiste.'],
        },
        {
      ...
      items: [
        {
          ...
          a: ['Penrose está ahora mismo en una beta pequeña solo por invitación. Únete a la lista de espera y te contactaremos a medida que abramos más invitaciones.'],
        },
        {
      ...
      items: [
        {
          ...
          a: ['Sí — Penrose usa la identidad del AT Protocol. Si todavía no tienes un nombre de usuario de Bluesky, crear uno toma un minuto y puedes usarlo aquí.'],
        },
        {
          q: '¿Qué pasa con mi nombre de usuario y seguimientos existentes de Bluesky?',
          a: ['Vienen contigo. Tus publicaciones públicas y seguimientos en Bluesky se quedan exactamente como están hoy. Penrose añade la capa privada; no reemplaza la pública.'],
        },
        {
        ...
        },
        {
          ...
          a: [
            'Tu contenido privado se vuelve permanentemente inaccesible. Esto es intencional: si Penrose tuviera una forma de recuperarlo por ti, Penrose también podría leer tu contenido privado — rompiendo la promesa central.',
        ...
        {
          q: '¿Puedo usar Penrose en más de un dispositivo?',
          a: [
            'Sí. Penrose es multi-dispositivo por diseño. No emparejas dispositivos ni sincronizas llaves entre ellos manualmente; tus llaves cifradas ya viven en infraestructura pública (el servidor de Penrose y tu PDS de Bluesky), y cualquier dispositivo puede desbloquearlas con las mismas tres credenciales: tu nombre de usuario de Bluesky, tu contraseña de Bluesky y tu contraseña de cifrado de Penrose.',
