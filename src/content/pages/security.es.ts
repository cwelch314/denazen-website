export default {
  meta: {
    title: 'Rhize',
    description: 'Cómo reportar una vulnerabilidad de seguridad en Rhize y qué esperar de nosotros a cambio.',
  },
  heading: 'Política de Seguridad',
  draftNotice: {
    title: 'Borrador — aún no listo para revisión técnica o de investigación',
    body: 'Esta política es un borrador previo al lanzamiento. El contenido, el alcance y las afirmaciones pueden cambiar antes de que Rhize esté disponible públicamente. No cites esta versión.',
  },
  leadBefore: 'Rhize está construido en torno a sólidas garantías de privacidad y cifrado. Publicamos nuestra ',
  ...
  reporting: {
    ...
    p1Before: 'Si crees que has encontrado una vulnerabilidad de seguridad en Rhize, repórtala de forma privada escribiendo a ',
  ...
  scope: {
    ...
    inScope: [
      ...
      {
        kind: 'plain',
        text: 'La app móvil de Rhize publicada en la App Store y Google Play — errores criptográficos, de autenticación, autorización o manejo de datos en la compilación publicada.',
      },
      {
        kind: 'plain',
        text: 'Endpoints del servidor de Rhize — el API gateway, el inbox, el índice de publicaciones, el manejo de solicitudes de amistad. Incluye bypass de autenticación, fallos de autorización, inyección y problemas de fuga de datos.',
      },
      {
        kind: 'code',
    ...
    outOfScope: [
      ...
      'Ingeniería social al personal o usuarios de Rhize.',
  ...
  bugBounty: {
    ...
    body: 'Rhize no ofrece actualmente recompensas pagadas por errores. Proporcionamos reconocimiento público para los reportes válidos y podemos ofrecer otras formas de reconocimiento a medida que el producto madure. Está previsto un programa de recompensas pagadas después del lanzamiento.',
  },

  acknowledgments: {
    heading: 'Agradecimientos',
    before: 'Los investigadores que han reportado problemas de forma responsable a Rhize están listados en nuestra ',
  ...
  changelog: {
    ...
    before: 'Los cambios importantes en los documentos públicos de seguridad de Rhize — incluido el libro blanco de la arquitectura de cifrado — se registran en el ',
    linkText: 'registro de cambios de seguridad',
    after: '. Si has revisado antes la postura de seguridad de Rhize, esa es la forma más rápida de ver qué ha cambiado.',
  },
};
